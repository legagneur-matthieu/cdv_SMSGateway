...
function dwf_js() {
    ...
    this.freetile = function (id) {
        if (!this.freetile_called) {
            this.include_script("src/js/freetile/jquery.freetile.min.js");
            this.freetile_called = true;
        }
        $("#" + id).freetile();
    };

    this.stalactite_called = false;
    ...
    this.stalactite = function (id, duration) {
        if (!this.stalactite_called) {
            this.include_script("src/js/stalactite/stalactite.js");
            this.stalactite_called = true;
        }
        $("#" + id).stalactite({
    ...
    this.shuffleLetters_called = false;
    ...
    this.shuffleLetters = function (id) {
        if (!this.shuffleLetters_called) {
            this.include_script("src/js/shuffleletters/jquery.shuffleLetters.js");
            this.shuffleLetters_called = true;
        }
        $("#" + id).shuffleLetters();
    };


    this.datatable_called = false;
    ...
    this.ckeditor = function (id) {
        if (!this.ckeditor_called) {
            this.include_script("src/js/ckeditor/ckeditor.js");
            this.ckeditor_called = true;
        }
        CKEDITOR.replace(id);
    };
    ...
    this.syntaxhighlighter_called = false;
    ...
    this.syntaxhighlighter = function () {
        if (!this.syntaxhighlighter_called) {
            ...
            this.syntaxhighlighter_called = true;
        }
        $("code").addClass("bruch: js");
    };

    this.mime_content_type_called = false;
    ...
    this.mime_content_type = function (file) {
        if (!this.mime_content_type_called) {
            this.include_script("src/js/filetypes/filetypes.min.js");
            this.mime_content_type_called = true;
        }
        return Stretchr.Filetypes.mimeFor(file);
    };

    this.videojs_called = false;
